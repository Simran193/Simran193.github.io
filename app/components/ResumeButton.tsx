...
const ResumeButton = () => {
	return (
		<Link
			href="https://drive.google.com/file/d/1nXv4PVfILXG8c-vZdfP7Uuyy-SPL9RSs/view?usp=sharing"
			target="_blank"
		>
			<button
				type="button"
				...
				onClick={() =>
					alert(
						"Now you will see a link. Click on download to download the Resume in PDF Format. Thanks for visit!!",
					)
				}
			>
				<Image
